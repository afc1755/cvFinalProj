...
def train():
    ...
    cfg.rot_90 = True
    cfg.num_rois = 32
    cfg.base_net_weights = os.path.join('model\\wtcwillis_frcnn_last.hdf5')  # Model to load weights from

    # TODO: the only file should to be change for other data to train
    cfg.model_path = './model/wtcwillis_frcnn_new.hdf5'  # New model to train
    cfg.simple_label_file = 'building_labels.txt'  # Label to read in
